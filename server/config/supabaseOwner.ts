...
// IMPORTANTE: Configurar SUPABASE_LOCAL_URL e SUPABASE_LOCAL_SERVICE_KEY para habilitar multi-tenant
...
if (supabaseOwnerUrl && supabaseOwnerKey) {
  console.log('[SUPABASE_LOCAL] ✅ Conectado com sucesso via secrets SUPABASE_LOCAL_URL/KEY');
} else {
